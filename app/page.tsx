          ...
          <input
            ...
            placeholder={
              isEnglish
                ...
                : 'O buscar por ciudad, condado o título...'
            }
            defaultValue={query}
            style={inputStyle}
          />
        ...
        {listings.length === 0 ? (
          <p style={{ textAlign: 'center', color: '#6b7280' }}>
            {isEnglish
              ...
              : 'No se encontraron casas que coincidan con su búsqueda.'}
          </p>
        ) : (
          <div
            style={{
          ...
          {[
            {
              ...
              title: isEnglish ? 'Bilingual Agents' : 'Agentes Bilingües',
              desc: isEnglish
            ...
            },
            {
              ...
              title: isEnglish ? 'Legal Support' : 'Asesoría Legal',
              desc: isEnglish
