  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="bg-blue-900 text-white py-20 px-6 text-center">
        <h1 className="text-4xl font-bold mb-4">Directorio de Real Estate Latino</h1>
        <p className="mb-8 opacity-90">Recursos y expertos bilingües para la comunidad de Georgia.</p>
      ...
      <section className="py-16 bg-gray-50 text-center">
        ...
        <div className="max-w-md mx-auto bg-white p-6 rounded-xl shadow-lg border-t-4 border-green-600">
           ...
           <Link href="/recursos/calculadora" className="text-green-600 font-bold block mt-4 hover:underline">Calcular Ahora →</Link>
        </div>
      </section>
    </main>
  );
