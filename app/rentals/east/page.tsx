...
export default function RegionalPage() {
  ...
  return (
    <main style={{ padding: '40px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'sans-serif', backgroundColor: '#f9fafb', minHeight: '100vh' }}>
      ...
      <h1 style={{ color: '#1e3a8a', marginTop: '24px', fontSize: '2.2rem' }}>East Georgia: Analytics 2026</h1>
      <div style={{ marginTop: '30px' }}>
        <section style={sectionStyle}>
          <h2>📊 Market Overview</h2>
          <p><strong>Average Rent:</strong> ,217</p>
          <p><strong>Primary Cities:</strong> Augusta, Evans</p>
          <p><strong>Market Trend:</strong> <span style={{color: '#92400e', fontWeight: 'bold'}}>Growth</span></p>
        </section>
        <section style={sectionStyle}>
          <h2>🏘️ Rental Unit Details</h2>
          <p>The inventory in East Georgia consists primarily of single-family rentals and mid-rise apartments.</p>
        </section>
      </div>
    </main>
  );
